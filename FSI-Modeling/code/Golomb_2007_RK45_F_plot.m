function [gD,I,F]=Golomb_2007_RK45_F_plot(I_range,no_I_steps,gD_range,no_gD_steps,no_secs,theta_m)
...
parfor Ivar = 1:no_I_steps
    ...
    [Vs,~,~,~] = Golomb_2007_RK45(no_gD_steps,I(Ivar),no_secs*1000,theta_m,gD',0);
...
save(['Golomb_2007_RK45_F_plot_',num2str(theta_m),'.mat'],'I','gD','F')
...
save_as_pdf(gcf,['Golomb_2007_RK45_F_plot_',num2str(theta_m)])
...
save_as_pdf(gcf,['Golomb_2007_RK45_burst_plot_',num2str(theta_m)])