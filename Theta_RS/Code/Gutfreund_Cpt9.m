function [data, name] = Gutfreund_Cpt9(Iconst, tspan, save_flag, varargin)
...
model_eqns = ['dv/dt=(Iconst+@current)/Cm; Cm=.9; v(0)=-65;',... % +I(t)
    '{iNaP,iKs,iNaG,iKDRG,gleak,CaDynT,iCaT,iKCaT,iStep};',...
    ...
    'tau_fast=5; tauh=tau_fast; taum=tau_fast;',... %%% 'offset=0; Koffset=offset; Noffset=offset;',...
    'slow_offset=0; slow_offset_correction=0; Ks_offset=slow_offset-slow_offset_correction; NaP_offset=slow_offset;',...
    'fast_offset=0; fast_offset_correction=0; Noffset=fast_offset; Koffset=fast_offset-fast_offset_correction;',...
    'fast_denom=1; gKDR=23.4/fast_denom; gNa=45/fast_denom;',... % C_mult*ones(1, 2)),...
