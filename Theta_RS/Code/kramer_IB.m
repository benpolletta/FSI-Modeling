...
switch sim_mode
    ...
    case 4                                                                  % IB only, no gamma
        ...
        vary = { 'IB->IB','gSYN',[0, 0.1, 0.5 1]/N; % AMPA conductance
        ...
        switch vary_mode
            case 1
                vary = { 'IB','PPstim',[-1 -2 -3 -4 -5];     % IBPPstim
                         'FS->IB','gSYN',[.1 .2 .3 .4 .5]/N}; % gGABAafe
            case 2
                vary = { 'IB->IB','gSYN',[.2 .5 .3]/N;     % gAMPAee
                         'FS->IB','gSYN',[.8 1 1.3 1.5]/N}; % gGABAafe
             case 3
                vary = { 'IB->IB','gNMDA',[1 2 3]/N;               % IBPPstim
                         'FS->IB','gSYN',[.3 .5 .6]/N};         % gGABAafe
        end
    ...
    case 7                                                                  % NG only, no gamma
        ...
        vary = { 'NG','PPstim',[-2 -3.5 -5 -6.5 -8]; % AMPA conductance
                 'NG->NG','gSYN',[.1 .3 .6 1 2]/Nng};        % NMDA conductance
        vary = { 'NG','PPstim',[-3.5 -5 ]; % AMPA conductance
                 'NG->NG','gSYN',[.3 .6 ]/Nng};        % NMDA conductance
%          vary = [];
...
if include_IB
    ...
    spec.populations(i).parameters = {...
      'VIC',-65,'ICnoise',ICnoise,'Cm',Cm,'El',-67,'gl',gl,...
...
if include_NG
    ...
    spec.populations(i).parameters = {...
      'VIC',-65,'ICnoise',ICnoise,'Cm',Cm,'El',-67,'gl',0.1,...
...
if include_IB
    ...
    spec.connections(i).parameters = {'gSYN',gAMPAee,'ESYN',EAMPA,'tauDx',tauAMPAd,'tauRx',tauAMPAr,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero, ...
...
if include_IB && include_NG
    ...
    spec.connections(i).parameters = {'gSYN',gAMPAei,'ESYN',EAMPA,'tauDx',tauAMPAd,'tauRx',tauAMPAr,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero, ...
...
if include_IB && include_RS
    ...
    spec.connections(i).mechanism_list = {'IBaIBdbiSYNseed','iNMDA'};
    spec.connections(i).parameters = {'gSYN',gAMPA_ibrs,'ESYN',EAMPA,'tauDx',tauAMPAd,'tauRx',tauAMPAr,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero, ...
...
if include_NG
    ...
    spec.connections(i).parameters = {'gSYN',gGABAaii,'ESYN',EGABA,'tauDx',tauGABAad,'tauRx',tauGABAar,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero,...
        'gGABAB',gGABAbii,'EGABAB',EGABA,'tauGABABd',tauGABAbd,'tauGABABr',tauGABAbr,'gGABAB_hetero',gSYNhetero,  ...
        'TmaxGABAB',TmaxGABAB ...
        };
end
...
if include_NG && include_IB
    ...
    spec.connections(i).mechanism_list = {'IBaIBdbiSYNseed','iGABABAustin'};
    spec.connections(i).parameters = {'gSYN',gGABAaie,'ESYN',EGABA,'tauDx',tauGABAad,'tauRx',tauGABAar,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero,...
        'gGABAB',gGABAbie,'EGABAB',EGABA,'tauGABABd',tauGABAbd,'tauGABABr',tauGABAbr,'gGABAB_hetero',gSYNhetero, ...
        'TmaxGABAB',TmaxGABAB ...
        };
end
...
if include_NG && include_RS
    ...
    spec.connections(i).mechanism_list = {'IBaIBdbiSYNseed','iGABABAustin'};
    spec.connections(i).parameters = {'gSYN',gGABAa_ngrs,'ESYN',EGABA,'tauDx',tauGABAad,'tauRx',tauGABAar,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero,...
        'gGABAB',gGABAb_ngrs,'EGABAB',EGABA,'tauGABABd',tauGABAbd,'tauGABABr',tauGABAbr,'gGABAB_hetero',gSYNhetero, ...
        'TmaxGABAB',TmaxGABAB ...
        };
end
...
if include_FS && include_IB
    ...
    spec.connections(i).mechanism_list = {'IBaIBdbiSYNseed'};
    spec.connections(i).parameters = {'gSYN',gGABAafe,'ESYN',EGABA,'tauDx',tauGABAad,'tauRx',tauGABAar,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero,...
        };
end
...
if include_FS && include_RS
    ...
    spec.connections(i).mechanism_list = {'IBaIBdbiSYNseed'};
    spec.connections(i).parameters = {'gSYN',gGABAa_fsrs,'ESYN',EGABA,'tauDx',tauGABAad,'tauRx',tauGABAar,'fanout',inf,'ICnoise',0,'gSYNhetero',gSYNhetero,...
        };
end
