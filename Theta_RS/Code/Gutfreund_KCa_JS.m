function data = Gutfreund_KCa_JS(Iconst, I_app, varargin)
...
model_eqns = ['dv/dt=Iconst+I(t)+@current/Cm; Cm=.25; v(0)=-65;',...
    ...
    sprintf('gKs=0.084; gNaP=0.025; gl=0.025; Iconst=%f;', Iconst),...    %  halfKs=-60; halfNaP=-60; gNaP=0.0125; 
...
try 
    ...
    save_as_pdf(gcf, [sprintf('Figures/gutfreund_KCa_JS_Iconst%f_Iapp%f', Iconst, I_app), vary_label])
