function [data, name] = Gutfreund_KCa(Iconst, tspan, save_flag, varargin)
...
model_eqns = ['dv/dt=(Iconst+I(t)+@current)/Cm; Cm=.25; v(0)=-65;',...
    ...
    sprintf('gKs=0.084; gNaP_denom=3.36; gNaP=gKs/gNaP_denom; Iconst=%g;', Iconst),...    %  halfKs=-60; halfNaP=-60; gKs=0.084; gNaP=0.025; gl=0.025; gCa=0.02; %%% 
