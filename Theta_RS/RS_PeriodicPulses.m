...
model_eqns = ['dv/dt=(I_const+@current)/Cm; Cm=2.7; v(0)=-65;',...
    ...
    'Cm_factor=Cm/.25; gKCa=Cm_factor*0.005; gCa=Cm_factor*.02; gNa=Cm_factor*12.5; gKDR=Cm_factor*5; gl=Cm_factor*.025;',...
