function [data, name] = Gutfreund_KCa_PRC_model(I_const, tspan, save_flag, varargin)
...
model_eqns = ['dv/dt=(I_const+I(t)+@current)/Cm; Cm=.25; v(0)=-65;',...
    ...
    sprintf('gKs=0.134; gNaP_denom=3.36; gNaP=gKs/gNaP_denom; I_const=%g;', I_const),...    % gKs=0.124; halfKs=-60; halfNaP=-60; gKs=0.084; gNaP=0.025; gl=0.025; gCa=0.02; %%% 
