function [data, name] = Gutfreund_RS_Dave_FS(I_const, tspan, save_flag, Nrs, Nfs, varargin)
...
spec.populations(1).equations = ['dv/dt=(I_const+@current)/Cm; Cm=1.8; v(0)=-65;',... % +I(t)
