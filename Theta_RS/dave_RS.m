...
spec.populations(1).equations = {['V''=(I(t)+current)/Cm; V(0)=-65;',...
    'I(t)=I_app*((t/ton)*(t<=ton)+(ton<t&t<toff))*(1+rand*.25); ton=500;',... % gNaP=gM/3.3;',...
...
spec.populations(1).parameters = {...
    'V_IC',-65,'IC_noise',0,'Cm',.9,'E_l',-67,'E_l_std',0,'g_l',.2,'V_noise',.3,...
    'gNaF',100,'gKDR',33,'E_KDR',-85,'gM',0.67,'E_M',-85,'gNaP',.2,...
    };
