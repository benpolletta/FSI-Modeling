...
model_eqns = ['dv/dt=(I_const+I(t)+@current)/Cm; Cm=.25; v(0)=-65;',...
    ...
    sprintf('gKs=0.084; gNaP=gKs/3.36; gl=0.025; gCa=0.02; I_const=%f;', I_const),...    %  halfKs=-60; halfNaP=-60; gNaP=0.0125; 
    ...
    sprintf('pulse = 0; ton=500; toff=%f; I_app=%f;', tspan, I_app),... %  (ton<t&t<toff) 
