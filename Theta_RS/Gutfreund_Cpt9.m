...
model_eqns = ['dv/dt=(I_const+@current)/Cm; Cm=.9; v(0)=-65;',... % +I(t)
    ...
    'tau_fast=5; tau_h=tau_fast; tau_m=tau_fast;',... %%% 'offset=0; Koffset=offset; Noffset=offset;',...
    'slow_offset=0; slow_offset_correction=0; Ks_offset=slow_offset-slow_offset_correction; NaP_offset=slow_offset;',...
    'fast_offset=0; fast_offset_correction=0; NaF_offset=fast_offset; KDR_offset=fast_offset-fast_offset_correction;',...
